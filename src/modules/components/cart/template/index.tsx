...
const CartLayout = (props: any) => {
    ...
    const { updateToCartHandler, removeToCartHandler, getCartHandler } = props
                ...
                <div>
                    {placeOrder
                        ...
                        <div className="my-10 text-center font-bold">
                            <div className="text-3xl text-green-700">Order place successfully</div>
                            <button onClick={() => naviagate("/")} className="text-xl text-white bg-black border-0 px-3 my-5 py-1">
                                Go to shop
                            </button>
                        </div>
