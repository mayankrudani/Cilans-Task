    ...
    return (
        <div className="bg-[#F1F1F1] py-10 px-5 lg:px-40">
            <div className="grid grid-cols-1 text-center lg:text-start lg:grid-cols-2 gap-x-44">
                <div>
                    <div className="text-3xl sm:text-5xl lg:text-6xl font-normal my-8">Collections</div>
                ...
                <div className="w-40 lg:w-72 mx-auto lg:mx-0 relative mt-10 lg:mt-0">
                    ...
                    <div className="w-40 lg:w-72 h-full rounded-tl-[100px] rounded-br-[100px] border-2 border-[#AFAFAF] absolute top-2 -right-2 z-[0]"></div>
                </div>
            </div>
